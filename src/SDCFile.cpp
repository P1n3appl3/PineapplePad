...
//     DSTATUS result; uint16_t block; int i; uint32_t n; uint32_t errors = 0;
...
// }
//
// const char inFilename[] = "blah.lol";   // 8 characters or fewer
// const char outFilename[] = "nop.txt";   // 8 characters or fewer
//
// int main2(void){
//     UINT successfulreads, successfulwrites;
//     uint8_t c, x, y;
...
//             //ST7735_DrawChar(50, 50, c, ST7735_Color565(255, 255, 255), 0, 1);
